...
} from "../model/transaction.repository.js";
...
export const getTransactions = async (req, res) => {
  try {
    ...
    const data = await findTransactions(searchConfig, skip, limit);
    const totalCount = await countTransactions(searchConfig);
...
export const getStatistics = async (req, res) => {
  try {
    ...
    const data = await findStatistics(monthQuery, projectQuery);
...
export const getBarChart = async (req, res) => {
  try {
    ...
    const data = await findPriceRange(monthQuery, projectQuery);
...
export const getPieChart = async (req, res) => {
  try {
    ...
    const data = await findCategoryDistribution(monthQuery, projectQuery);
